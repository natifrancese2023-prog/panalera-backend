...
router.get(
  ...
  verificarToken,
  verificarRol(['dueno']),
  productosController.obtenerHistorialPrecios
);
...
router.get(
  ...
  verificarToken,
  verificarRol(['dueno']),
  productosController.obtenerHistorialCostos
);
...
router.get(
  ...
  verificarToken,
  verificarRol(['dueno']),
  productosController.obtenerKardex
);
...
router.get(
  ...
  verificarToken,
  verificarRol(['dueno']),
  productosController.obtenerHistorialCompras
);
...
router.get(
  ...
  verificarToken,
  verificarRol(['dueno']),
  productosController.obtenerHistorialVentas
);
